...
exports.ListarDetallesReembolsoByReciboId = exports.ListarDetallesReembolsoById = exports.ListarDetallesReembolso = exports.CrearDetalleReembolso = void 0;
...
var CrearDetalleReembolso = exports.CrearDetalleReembolso = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(articuloId, reciboId, cantidadDevuelta, subtotal) {
    var newDetalle;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return prisma.detalleReembolso.create({
            data: {
  ...
  return function CrearDetalleReembolso(_x, _x2, _x3, _x4) {
...
var ListarDetallesReembolso = exports.ListarDetallesReembolso = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var detallesReembolso;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return prisma.detalleReembolso.findMany();
        case 2:
          detallesReembolso = _context2.sent;
          return _context2.abrupt("return", detallesReembolso);
        case 4:
        case "end":
  ...
  return function ListarDetallesReembolso() {
...
var ListarDetallesReembolsoById = exports.ListarDetallesReembolsoById = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return prisma.detalleReembolso.findUnique({
            where: {
              id: Number(id)
            }
          });
        case 2:
          detallesReembolso = _context3.sent;
          return _context3.abrupt("return", detallesReembolso);
        case 4:
        case "end":
  ...
  return function ListarDetallesReembolsoById(_x5) {
 ...
 */
var ListarDetallesReembolsoByReciboId = exports.ListarDetallesReembolsoByReciboId = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(reciboId) {
    var detallesReembolso;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          detallesReembolso = _context4.sent;
          return _context4.abrupt("return", detallesReembolso);
        case 4:
        case "end":
  ...
  return function ListarDetallesReembolsoByReciboId(_x6) {
