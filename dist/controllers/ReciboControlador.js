...
exports.Reembolsar = exports.ListarRecibosByVenta = exports.ListarReciboById = exports.ListarRecibo = exports.CrearRecibo = void 0;
var ReciboServicio = _interopRequireWildcard(require("../Services/ReciboServicio"));
...
var ListarRecibo = exports.ListarRecibo = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return ReciboServicio.listarRecibo(usuario_id);
        case 4:
        ...
        case 8:
          ...
          res.status(500).json({
            mensaje: 'Error al listar los recibos'
          });
        case 12:
        case "end":
  ...
  return function ListarRecibo(_x, _x2) {
...
var CrearRecibo = exports.CrearRecibo = /*#__PURE__*/function () {
  ...
  return function CrearRecibo(_x3, _x4) {
...
var Reembolsar = exports.Reembolsar = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var usuario_id, _req$body, id, detalles, reciboReembolso;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          usuario_id = req.usuario.id;
          _req$body = req.body, id = _req$body.id, detalles = _req$body.detalles;
          _context3.prev = 2;
          _context3.next = 5;
          return ReciboServicio.Reembolsar(id, detalles, usuario_id);
        case 5:
          reciboReembolso = _context3.sent;
        ...
        case 9:
          ...
          console.error("Error al realizar el reembolso:", _context3.t0);
          res.status(500).json({
  ...
  return function Reembolsar(_x5, _x6) {
...
var ListarReciboById = exports.ListarReciboById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 2;
          _context4.next = 5;
          return ReciboServicio.ListarReciboById(id, usuario_id);
        case 5:
          recibo = _context4.sent;
        ...
        case 9:
          ...
          console.error("Error al obtener el recibo:", _context4.t0.message);
          res.status(500).json({
  ...
  return function ListarReciboById(_x7, _x8) {
 ...
 */
var ListarRecibosByVenta = exports.ListarRecibosByVenta = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id_venta, usuario_id, recibos;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 2;
          _context5.next = 5;
          return ReciboServicio.ListarReciboByVenta(id_venta, usuario_id);
        case 5:
  ...
  return function ListarRecibosByVenta(_x9, _x10) {
