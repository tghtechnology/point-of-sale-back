...
exports.reestablecerPOS = exports.listarPosEliminadosPorId = exports.listarPosEliminados = exports.listarPOSPorId = exports.listarPOS = exports.eliminarPOS = void 0;
var PuntoDeVentaServicio = _interopRequireWildcard(require("../Services/PuntoDeVentaServicio"));
...
var listarPOS = exports.listarPOS = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return PuntoDeVentaServicio.listarPOS();
        case 3:
          pos = _context.sent;
        ...
        case 7:
          ...
          res.status(500).json({
            mensaje: 'Error al listar los pos.'
          });
        case 11:
        case "end":
  ...
  return function listarPOS(_x, _x2) {
...
var listarPOSPorId = exports.listarPOSPorId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          id = req.params.id;
          _context2.next = 4;
          return PuntoDeVentaServicio.listarPOS(id);
        case 4:
          pos = _context2.sent;
          if (pos) {
            _context2.next = 7;
          ...
          return _context2.abrupt("return", res.status(404).json({
            error: "No se encontró el punto de venta"
          }));
        case 7:
          res.status(201).json(pos);
          _context2.next = 14;
        ...
        case 10:
          ...
          res.status(500).json({
            mensaje: 'Error al listar el pos.'
          });
        case 14:
        case "end":
  ...
  return function listarPOSPorId(_x3, _x4) {
...
var eliminarPOS = exports.eliminarPOS = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          id = req.params.id;
          _context3.next = 4;
          return PuntoDeVentaServicio.eliminarPOS(id);
        case 4:
          pos = _context3.sent;
          if (pos) {
            _context3.next = 7;
        ...
        case 10:
          ...
          res.status(500).json({
            mensaje: 'Error al eliminar el punto de venta.'
          });
        case 14:
        case "end":
  ...
  return function eliminarPOS(_x5, _x6) {
...
var reestablecerPOS = exports.reestablecerPOS = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          id = req.params.id;
          _context4.next = 4;
          return PuntoDeVentaServicio.reestablecerPos(id);
        case 4:
          pos = _context4.sent;
          if (pos) {
            _context4.next = 7;
        ...
        case 7:
          res.status(200).json({
            mensaje: 'Punto de venta reestablecido correctamente'
          });
          _context4.next = 14;
          break;
        case 10:
          ...
          res.status(500).json({
            mensaje: 'Error al reestablecer el punto de venta.'
          });
        case 14:
        case "end":
  ...
  return function reestablecerPOS(_x7, _x8) {
...
var listarPosEliminados = exports.listarPosEliminados = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return PuntoDeVentaServicio.listarPosEliminados();
        case 3:
          pos = _context5.sent;
          res.status(201).json(pos);
          _context5.next = 11;
  ...
  return function listarPosEliminados(_x9, _x10) {
...
var listarPosEliminadosPorId = exports.listarPosEliminadosPorId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          id = req.params.id;
          _context6.next = 4;
          return PuntoDeVentaServicio.listarPosEliminadosPorId(id);
        case 4:
          pos = _context6.sent;
          if (pos) {
            _context6.next = 7;
  ...
  return function listarPosEliminadosPorId(_x11, _x12) {
