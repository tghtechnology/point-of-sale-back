...
exports.verificarAuth = exports.isPropietario = exports.isEmpleado = exports.isAdmin = void 0;
 ...
 */
var verificarAuth = exports.verificarAuth = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var authorization, token, _jwt$verify, id, usuario;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", res.status(401).json({
            error: "Requiere token de autorización"
          }));
        case 3:
          token = authorization.split(' ')[1];
          _context.prev = 4;
          _jwt$verify = jwt.verify(token, process.env.SECRET), id = _jwt$verify.id;
          _context.next = 8;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 11:
          ...
          console.error("Error en middleware", _context2.t0);
 ...
 * Si no, responde con un error 403 (Prohibido).
 */
var isPropietario = exports.isPropietario = /*#__PURE__*/function () {
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          return _context3.abrupt("return", res.status(403).json({
            message: "Requiere rol de Propietario"
          }));
        case 9:
          _context3.next = 15;
          break;
        case 11:
          ...
          console.error("Error en middleware isPropietario:", _context3.t0);
  ...
  return function isPropietario(_x7, _x8, _x9) {
...
var isEmpleado = exports.isEmpleado = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 11:
          ...
          // Manejar cualquier error de la base de datos u otros errores
          console.error("Error en middleware", _context4.t0);
  ...
  return function isEmpleado(_x10, _x11, _x12) {
