...
var crearArticulo = exports.crearArticulo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, nombre, tipo_venta, precio, coste, ref, representacion, nombre_categoria, categoria, nuevoArticulo;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, nombre = _req$body.nombre, tipo_venta = _req$body.tipo_venta, precio = _req$body.precio, coste = _req$body.coste, ref = _req$body.ref, representacion = _req$body.representacion, nombre_categoria = _req$body.nombre_categoria;
          _context.next = 4;
          return CategoriaServicio.listarCategoriaPorId(nombre_categoria);
        case 4:
        ...
        case 8:
          _context.next = 10;
          return ArticuloServicio.crearArticulo(nombre, tipo_venta, precio, coste, ref, representacion, nombre_categoria);
        case 10:
          nuevoArticulo = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          res.status(500).json({
            mensaje: "Error al obtener la lista de artículos."
          });
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return ArticuloServicio.listarArticuloPorId(text_id);
        case 4:
...
var actualizarArticulo = exports.actualizarArticulo = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var text_id, _req$body2, nombre, tipo_venta, precio, coste, ref, representacion, nombre_categoria, articulo, categoria;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          text_id = req.params.text_id;
          _req$body2 = req.body, nombre = _req$body2.nombre, tipo_venta = _req$body2.tipo_venta, precio = _req$body2.precio, coste = _req$body2.coste, ref = _req$body2.ref, representacion = _req$body2.representacion, nombre_categoria = _req$body2.nombre_categoria;
          _context4.next = 5;
          return ArticuloServicio.modificarArticulo(text_id, nombre, tipo_venta, precio, coste, ref, representacion, nombre_categoria);
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          text_id = req.params.text_id;
          _context5.next = 4;
          return ArticuloServicio.eliminarArticulo(text_id);
        case 4:
          res.status(200).json({
