...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } //import { connect } from "../database";
//Crear nueva categoría
var crearCategoria = exports.crearCategoria = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, nombre, color, nuevaCategoria;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, nombre = _req$body.nombre, color = _req$body.color;
          _context.next = 4;
          return CategoriaServicio.crearCategoria(nombre, color);
        case 4:
          nuevaCategoria = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return CategoriaServicio.listarCategoriaPorId(text_id);
        case 4:
...
var actualizarCategoria = exports.actualizarCategoria = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var text_id, _req$body2, nombre, color, categoria;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          text_id = req.params.text_id;
          _req$body2 = req.body, nombre = _req$body2.nombre, color = _req$body2.color;
          _context4.next = 5;
          return CategoriaServicio.modificarCategoria(text_id, nombre, color);
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          text_id = req.params.text_id;
          _context5.next = 4;
          return CategoriaServicio.eliminarCategoria(text_id);
        case 4:
          res.status(200).json({
...
module.exports = {
  ...
  obtenerCategoriaPorId: obtenerCategoriaPorId,
