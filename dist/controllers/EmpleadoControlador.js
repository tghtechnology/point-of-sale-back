...
exports.listarEmpleados = exports.listarEmpleadoPorId = exports.eliminarEmpleadoPorId = exports.editarEmpleado = exports.crearEmpleado = void 0;
...
var crearEmpleado = exports.crearEmpleado = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usuario_id, _req$body, nombre, email, telefono, cargo, pais, password, propietarioId, nuevoEmpleado;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          usuario_id = req.usuario.id;
          _context.prev = 1;
          _req$body = req.body, nombre = _req$body.nombre, email = _req$body.email, telefono = _req$body.telefono, cargo = _req$body.cargo, pais = _req$body.pais, password = _req$body.password, propietarioId = _req$body.propietarioId;
          _context.next = 5;
          return EmpleadoServicio.crearEmpleado(nombre, email, telefono, cargo, pais, password, propietarioId, usuario_id);
        case 5:
        ...
        case 9:
          ...
          console.error("Error al crear empleado:", _context.t0.message);
          res.status(500).json({
  ...
  return function crearEmpleado(_x, _x2) {
...
var listarEmpleados = exports.listarEmpleados = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          usuario_id = req.usuario.id;
          _context2.next = 4;
          return EmpleadoServicio.listarEmpleados(usuario_id);
        case 4:
        ...
        case 8:
          ...
          console.error("Error al obtener la lista de empleados:", _context2.t0.message);
          res.status(500).json({
  ...
  return function listarEmpleados(_x3, _x4) {
...
var listarEmpleadoPorId = exports.listarEmpleadoPorId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 2;
          _context3.next = 5;
          return EmpleadoServicio.listarEmpleadoPorId(id, usuario_id);
        case 5:
        ...
        case 9:
          ...
          console.error("Error al obtener el empleado:", _context3.t0.message);
          res.status(500).json({
  ...
  return function listarEmpleadoPorId(_x5, _x6) {
...
var editarEmpleado = exports.editarEmpleado = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, usuario_id, _req$body2, nombre, email, telefono, cargo, pais, password, empleado;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          id = req.params.id;
          usuario_id = req.usuario.id;
          _req$body2 = req.body, nombre = _req$body2.nombre, email = _req$body2.email, telefono = _req$body2.telefono, cargo = _req$body2.cargo, pais = _req$body2.pais, password = _req$body2.password;
          _context4.next = 6;
          return EmpleadoServicio.editarEmpleado(id, nombre, email, telefono, cargo, pais, usuario_id);
        case 6:
        ...
        case 10:
          ...
          console.error("Error al editar el empleado:", _context4.t0.message);
          res.status(500).json({
  ...
  return function editarEmpleado(_x7, _x8) {
...
var eliminarEmpleadoPorId = exports.eliminarEmpleadoPorId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 2;
          _context5.next = 5;
          return EmpleadoServicio.eliminarEmpleadoPorId(id, usuario_id);
        case 5:
          res.status(200).json({
        ...
        case 8:
          ...
          console.error("Error al eliminar el empleado:", _context5.t0.message);
          res.status(500).json({
  ...
  return function eliminarEmpleadoPorId(_x9, _x10) {
