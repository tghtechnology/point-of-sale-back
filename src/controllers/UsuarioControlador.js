...
export const eliminarTemporalmente = async (req, res) => {
  try {
    ...
    if (results) {
      ...
      res
        .status(400)
        .json({ mensaje: "La cuenta ya ha sido eliminada temporalmente" });
    ...
    res
      .status(500)
      .json({ mensaje: "Error al eliminar la cuenta temporalmente" });
  }
};
  ...
  try {
    ...
    if (results) {
      ...
      res
        ...
        .json({
          mensaje:
            "La cuenta no está eliminada por lo tanto no puede restaurarse",
        });
...
export const eliminarPermanentemente = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ mensaje: "Error al eliminar la cuenta permanentemente" });
  }
};
