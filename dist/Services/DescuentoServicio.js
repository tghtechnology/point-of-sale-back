 ...
 */
var crearDescuento = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(nombre, tipo_descuento, valor, usuario_id) {
    var tiposValidos, valor_calculado, usuario, id_punto, id_puntoDeVenta, newDescuento;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // Opciones de tipos de descuento que se deben ingresar
          tiposValidos = ["PORCENTAJE", "MONTO"]; // En el caso se ingrese otro tipo
        ...
        case 3:
          valor_calculado = valor; // En el caso que se ingrese porcentaje(%)
        ...
        case 14:
          ...
          return _context.abrupt("return", newDescuento);
        case 16:
        case "end":
  ...
  return function crearDescuento(_x, _x2, _x3, _x4) {
...
var eliminarDescuento = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          return _context2.abrupt("return", descuento);
        case 7:
        case "end":
  ...
  return function eliminarDescuento(_x5, _x6) {
 ...
 */
var obtenerDescuentoById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.next = 5;
          return prisma.descuento.findFirst({
            where: {
              id: Number(id),
              id_puntoDeVenta: id_puntoDeVenta
            }
        ...
        case 5:
          ...
          return _context3.abrupt("return", descuento);
        case 7:
        case "end":
  ...
  return function obtenerDescuentoById(_x7, _x8) {
 ...
 */
var modificarDescuento = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, nombre, tipo_descuento, valor, estado, usuario_id) {
    var tiposValidos, nuevoValorCalculado, id_puntoDeVenta, descuento;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          tiposValidos = ["PORCENTAJE", "MONTO"]; // Validar tipo de descuento
          if (tiposValidos.includes(tipo_descuento)) {
            _context4.next = 3;
            break;
          }
        ...
        case 10:
          descuento = _context4.sent;
          return _context4.abrupt("return", descuento);
        case 12:
        case "end":
  ...
  return function modificarDescuento(_x9, _x10, _x11, _x12, _x13, _x14) {
...
var obtenerDescuentos = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 5:
          ...
          return _context5.abrupt("return", descuentos);
        case 7:
        case "end":
  ...
  return function obtenerDescuentos(_x15) {
 ...
 * @throws {Error} - Si ocurre un error al buscar los descuentos.
 */
var obtenerDescuentosEliminados = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(usuario_id) {
    var id_puntoDeVenta, descuentoseliminados;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          descuentoseliminados = _context6.sent;
          return _context6.abrupt("return", descuentoseliminados);
        case 7:
        case "end":
  ...
  return function obtenerDescuentosEliminados(_x16) {
 ...
 * @throws {Error} - Si el ID no es válido o si ocurre un error al actualizar el descuento.
 */
var cambiarEstadoDescuento = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id, nuevoEstado, usuario_id) {
    var id_puntoDeVenta, descuento;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          _context7.next = 5;
          return prisma.descuento.updateMany({
            where: {
              id: Number(id),
              id_puntoDeVenta: id_puntoDeVenta
            },
        ...
        case 5:
          descuento = _context7.sent;
          return _context7.abrupt("return", descuento);
        case 7:
        case "end":
  ...
  return function cambiarEstadoDescuento(_x17, _x18, _x19) {
...
var obtenerIdPunto = /*#__PURE__*/function () {
  ...
  return function obtenerIdPunto(_x20) {
...
module.exports = {
  ...
  obtenerDescuentoById: obtenerDescuentoById,
  modificarDescuento: modificarDescuento,
  obtenerDescuentos: obtenerDescuentos,
  cambiarEstadoDescuento: cambiarEstadoDescuento,
  obtenerDescuentosEliminados: obtenerDescuentosEliminados
};