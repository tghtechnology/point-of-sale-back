export const cuerpoRestaurado = (nombreUsuario) => {
    return `
    <html>
    <head>
        <style>
    ...
    <body>
        ...
        <div class="content">
            <h2>Cuenta restaurada con éxito</h2>
            <p>¡Hola ${nombreUsuario}!<br>
            Nos complace informarte que tu cuenta ha sido restaurada con éxito. 
            <br>
            ...
            <br>
            ¡Gracias por tu paciencia y bienvenido de nuevo! 🎉</p>
        </div>
        <div class="footer">
