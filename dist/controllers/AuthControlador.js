...
exports.obtenerDatosUsuarioPorId = exports.logout = exports.login = exports.enviarTokenCambioPassword = exports.cambiarPassword = void 0;
var AuthServicio = _interopRequireWildcard(require("../Services/AuthServicio"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error("Error al iniciar sesión:", _context.t0.message);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return AuthServicio.logout(token);
        case 4:
...
var obtenerDatosUsuarioPorId = exports.obtenerDatosUsuarioPorId = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, usuario_id, usuarioId, usuario;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          _context3.next = 8;
          return AuthServicio.obtenerDatosUsuarioPorId(usuarioId, usuario_id);
        case 8:
        ...
        case 11:
          return _context3.abrupt("return", res.status(200).json(usuario));
        case 14:
          _context3.prev = 14;
...
var enviarTokenCambioPassword = exports.enviarTokenCambioPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _context4.prev = 3;
          _context4.next = 6;
          return AuthServicio.enviarCorreoCambioPass(email);
        case 6:
  ...
  return function enviarTokenCambioPassword(_x7, _x8) {
...
var cambiarPassword = exports.cambiarPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return AuthServicio.cambiarPassword(token, password);
        case 4:
  ...
  return function cambiarPassword(_x9, _x10) {
