...
exports.ObtenerVentaPorId = exports.ListarVentas = exports.CrearVenta = void 0;
var VentaServicio = _interopRequireWildcard(require("../Services/VentaServicio"));
...
var CrearVenta = exports.CrearVenta = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usuario_id, _req$body, detalles, tipoPago, impuestoId, descuentoId, clienteId, usuarioId, dineroRecibido, nuevaVenta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          usuario_id = req.usuario.id;
          _req$body = req.body, detalles = _req$body.detalles, tipoPago = _req$body.tipoPago, impuestoId = _req$body.impuestoId, descuentoId = _req$body.descuentoId, clienteId = _req$body.clienteId, usuarioId = _req$body.usuarioId, dineroRecibido = _req$body.dineroRecibido;
          _context.next = 5;
          return VentaServicio.CrearVenta(detalles, tipoPago, impuestoId, descuentoId, clienteId, usuarioId, dineroRecibido, usuario_id);
        case 5:
          nuevaVenta = _context.sent;
        ...
        case 10:
          ...
          console.error('Error al crear la venta:', _context.t0);
          res.status(500).json({
 ...
 */
var ListarVentas = exports.ListarVentas = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var usuario_id, ventas;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          usuario_id = req.usuario.id;
          _context2.next = 4;
          return VentaServicio.ListarVentas(usuario_id);
        case 4:
        ...
        case 8:
          ...
          res.status(500).json({
            mensaje: 'Error al listar las ventas'
          });
        case 12:
        case "end":
  ...
  return function ListarVentas(_x3, _x4) {
 ...
 */
var ObtenerVentaPorId = exports.ObtenerVentaPorId = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var usuario_id, id, venta;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          id = req.params.id;
          _context3.next = 5;
          return VentaServicio.ObtenerVentaPorId(id, usuario_id);
        case 5:
  ...
  return function ObtenerVentaPorId(_x5, _x6) {
